...
function runmath(s) {
    ...
    try {// We want to catch parse errors and die appropriately
        ...
        console.log('3333', grammar.ParserRules, grammar.ParserStart)
        ans = new nearley.Parser(grammar.ParserRules, grammar.ParserStart, { keepHistory: true }).feed(s);
        console.log("parser table:", parser.table);
