...
var grammar = {
    ...
    {"name": "MD_PERCENT", "symbols": ["MD_MEASURE", "__", "MD_PERCENT$string$2", "__", "MD_MEASURE"], "postprocess": ([m1,,,,m2],l, rej) => {log('m1 as a % on m2', m1, m2); return math.unit(math.divide(math.subtract(m1, m2), math.divide(m2, 100)), 'PERCENT')}},
    ...
    {"name": "MD_PERCENT", "symbols": ["MD_MEASURE", "__", "MD_PERCENT$string$3", "__", "MD_MEASURE"], "postprocess": ([m1,,,,m2],l, rej) => {log('m1 as a % off m2', m1, m2); return math.unit(math.divide(m1, math.divide(m2, 100)), 'PERCENT')}},
