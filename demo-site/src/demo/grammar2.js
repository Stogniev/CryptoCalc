...
var grammar = {
    ...
    {"name": "MD_MEASURE", "symbols": ["MD_MEASURE", "mul", "VALUE_PERCENT"], "postprocess": ([m,,p],l, rej) =>{console.log('m*p', m,p); return math.multiply(m, p.value/100) }},
    {"name": "MD_MEASURE", "symbols": ["MD_MEASURE", "divide", "VALUE_PERCENT"], "postprocess": ([m,,p],l, rej) => {console.log('m/p', m,p,p.value); return math.divide(m, p.value/100) }},
    ...
    {"name": "MD_PERCENT", "symbols": ["MD_PERCENT", "mul", "VALUE_NUM"], "postprocess": ([p,,n],l, rej) => {log(`%*n`,p,n, p.value); return math.multiply(p, n)}},
    {"name": "MD_PERCENT", "symbols": ["MD_PERCENT", "__", "VALUE_NUM"], "postprocess": ([p,,n],l, rej) => math.multiply(p/100, n)},
